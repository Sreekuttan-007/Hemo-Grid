                  ...
                  >
                    ...
                    <td className="py-3.5 px-4 whitespace-nowrap">
                      <span className={`px-2.5 py-1 rounded-full text-[11px] font-bold whitespace-nowrap inline-block ${
                        item.days_to_expiry <= 3 ? 'glass-pill-amber' :
                        item.days_to_expiry <= 7 ? 'glass-pill-amber opacity-90' : 'glass-pill-action'
                      }`}>
                    ...
                    <td className="py-3.5 px-4 whitespace-nowrap text-right">
                      <button
                        ...
                        className="px-3.5 py-1 rounded-full glass-pill-action text-[11px] font-bold whitespace-nowrap"
                      >
                        Inspect
                      </button>
                    </td>
